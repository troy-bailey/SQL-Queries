-- SQL Queries on the Sakila database
-- by Troy Bailey
-- 2018 09 18
...
USE sakila;
CREATE VIEW `Top 5 Grossing Categories` AS
SELECT category.name, SUM(payment.amount) -- as 'Gross Revenue'
FROM category
...
SELECT * FROM sakila.`top 5 grossing categories`;

-- 8c. You find that you no longer need the view top_five_genres. Write a query to delete it.
DROP VIEW sakila.`top 5 grossing categories`;